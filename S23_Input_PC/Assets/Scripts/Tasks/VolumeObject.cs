...
namespace StudyMismatch2D3D.S23_Input_PC {
    public class VolumeObject:ManipulableObject {
        ...
        public string CurrentMatrixInv {
            get {
        ...
        public Matrix4x4 CurrentMatrixInvM {
            get {
                float xDot = Vector3.Dot(Rotation * Vector3.right, Camera.main.transform.forward);
                float yDot = Vector3.Dot(Rotation * Vector3.up, Camera.main.transform.forward);
                float zDot = Vector3.Dot(Rotation * Vector3.forward, Camera.main.transform.forward);
        ...
        public override void Load() {
            ...
            material.EnableKeyword("RECT_ON");
            isLoaded = true;
        }
        ...
        //    material.SetVector("_RectCenter",Vector3.zero);
        //    material.SetVector("_RectNormal",Vector3.forward);
        ...
        //protected Vector3  rrr = Vector3.forward;
        //protected int xxx =0;
        //protected override void Update() {
        //    base.Update();
        //    SetVecNormal(Quaternion.Euler(1*xxx,2*xxx,3*xxx)*rrr);
        //    xxx++;
        //}
