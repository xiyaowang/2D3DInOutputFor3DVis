...
namespace StudyMismatch2D3D.S23_Input_Android_Unity5 {
    public class VolumeObject:ManipulableObject {
        ...
        protected override void Render() {
            ...
            float xDot = Vector3.Dot(Rotation * Vector3.right, Vector3.forward);
            float yDot = Vector3.Dot(Rotation * Vector3.up, Vector3.forward);
            float zDot = Vector3.Dot(Rotation * Vector3.forward, Vector3.forward);
