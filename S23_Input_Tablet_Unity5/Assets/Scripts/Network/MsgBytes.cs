...
namespace StudyMismatch2D3D.S23_Input_Android_Unity5 {
    ...
    public static class MsgBytes {
        ...
        public static byte[] Serialize(short i) { return BitConverter.GetBytes(i); }
        public static byte[] Serialize(int i) { return BitConverter.GetBytes(i); }
        public static byte[] Serialize(float f) { return BitConverter.GetBytes(f); }
        public static byte[] Serialize(double d) { return BitConverter.GetBytes(d); }
        public static byte[] Serialize(bool b) { return BitConverter.GetBytes(b); }
        public static byte[] Serialize(string s) { return Encoding.ASCII.GetBytes(s); }
